...
Pothos plants belong to the Araceae, or Arum family.


> The **<u>Araceae</u>** are a family of flowering plants where the flowers grow on a structure called a spadix, often surrounded or partly covered by a leaf-like bract called a spathe. 
...
<div style="display: flex; flex-direction:column; justify-content: center;  align-items: center;">
    <img src="/assets/ted.jpeg" alt="Description of image" style="width: 15rem; height: 18rem; border-radius:1rem;">
...
Siblings in the Arum family are known as Aroids. 
...
Satin Pothos are also in the Araceae family and are the aroid of the Golden Pothos. Contrary to popular belief, **Satin Pothos are not considered to be true Pothos, though it's in the name.** They fall under the **genus Scindapsus**. 
